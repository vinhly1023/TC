...
=begin
LeapPad Ultra Content: Check product information on New Arrivals page
=end

describe "LeapPad Ultra - New Arrivals Checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
