...
=begin
English Cabo Content: Check product information on New Arrivals page
=end

describe "CABO English - New Arrivals Checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
