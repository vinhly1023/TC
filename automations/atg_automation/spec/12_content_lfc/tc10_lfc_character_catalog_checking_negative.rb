...
=begin
English LFC Content: Verify Products that don't match the Character or Locale should not display
=end

describe "LFC English - Character Catalog Negative - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
