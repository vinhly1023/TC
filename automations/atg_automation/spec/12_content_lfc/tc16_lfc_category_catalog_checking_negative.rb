...
=begin
English LFC Content: Verify Products that don't match the Category/Content Type or Locale should not display
=end

describe "LFC English - Category Negative checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
