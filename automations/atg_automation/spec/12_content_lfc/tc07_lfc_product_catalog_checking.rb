...
=begin
English LFC Content: Verify that Products that match with Product Type and Locale should display
=end

describe "LFC English - Product catalog checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
