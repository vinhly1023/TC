...
=begin
English LFC Content: Verify that Products that match with Category/Content Type and Locale should display
=end

describe "LFC English - Category checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
