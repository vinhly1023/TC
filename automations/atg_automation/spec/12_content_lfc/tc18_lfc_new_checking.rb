...
=begin
ATG English LFC Content: Check product information on New Arrivals page
=end

describe "LFC English - New Arrivals Checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
