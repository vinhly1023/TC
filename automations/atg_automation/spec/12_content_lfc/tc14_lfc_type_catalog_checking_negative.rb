...
=begin
English LFC Content: Verify Products that don't match the Type Format or Locale should not display
=end

describe "LFC English - Type/Format Catalog Negative - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
