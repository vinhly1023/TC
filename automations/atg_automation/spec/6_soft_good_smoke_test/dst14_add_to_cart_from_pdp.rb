...
feature 'DST14 - Catalog - Add to Cart from PDP', js: true do
  before :all do
    # Login to LF account
  ...
  context 'Add App to Cart from PDP page' do
    ...
    scenario '4. Open Product Detail page' do
      atg_app_center_catalog_page.go_pdp prod_info[:prod_id]
    end

    scenario "5. Click on 'Add to Cart' button on PDP page" do
      atg_product_pdp_page.add_to_cart_from_pdp
    end
  end
