...
feature 'DST13 - Catalog - Add to Cart from Quick View overlay', js: true do
  before :all do
    # Login to LF account
  ...
  context 'Add Product to Cart from Quick View page' do
    ...
    scenario 'Get the number of added items in Cart page' do
      item_num1 = atg_app_center_catalog_page.cart_item_number
      pending "***The number of added items in Cart: #{item_num1}"
    end

    scenario "2. Open the Quick View overlay (ID = #{prod_info[:prod_id]})" do
    ...
    scenario "4. Click on 'Add to Cart' button from Quick View overlay" do
      atg_quick_view_overlay_page.add_to_cart_from_quickview
    end
  end
  ...
  context 'Verify Product information in Cart page' do
    ...
    scenario '2. Get Product information in Cart' do
