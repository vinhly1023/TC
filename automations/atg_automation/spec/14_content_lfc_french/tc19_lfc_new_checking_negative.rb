...
=begin
French LFC Content: Verify that apps are not supported for current locale shouldn't displayed on New page
=end

describe "LFC French - New Arrivals Negative Checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
