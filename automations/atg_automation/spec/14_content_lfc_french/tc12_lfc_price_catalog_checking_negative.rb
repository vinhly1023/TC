...
=begin
French LFC Content: Verify Products that don't match the Price or Locale should not display
=end

describe "English LFC - Price Catalog Negative - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
