...
=begin
French LFC Content: Verify Products that don't match the Product Type or Locale should not display
=end

describe "English LFC - Product Catalog Negative - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
