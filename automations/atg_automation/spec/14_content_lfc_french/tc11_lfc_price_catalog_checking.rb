...
=begin
French LFC Content: Verify that Products that match with Price and Locale should display
=end

describe "LFC French - Price catalog checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
