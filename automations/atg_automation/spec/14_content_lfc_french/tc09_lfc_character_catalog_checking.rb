...
=begin
French LFC Content: Verify that Products that match with Character and Locale should display
=end

describe "LFC French - Character catalog checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
