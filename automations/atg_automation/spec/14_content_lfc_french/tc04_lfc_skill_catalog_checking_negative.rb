...
=begin
French LFC Content: Verify Products that don't match the Skill or Locale should not display
=end

describe "LFC French - Skill Catalog Negative checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
