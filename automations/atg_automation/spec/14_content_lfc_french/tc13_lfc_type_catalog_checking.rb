...
=begin
French LFC Content: Verify that Products that match with Type/Format and Locale should display
=end

describe "LFC French - Type/Format catalog checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
