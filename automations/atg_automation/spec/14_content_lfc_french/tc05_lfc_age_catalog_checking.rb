...
=begin
French LFC Content: Verify that Products that match with Age range and Locale should display
=end

describe "French LFC Age catalog checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST}" do
