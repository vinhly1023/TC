...
=begin
French Cabo Content: Verify that Products that match with Age range, Locale and LeapPad3 platform should display
=end

describe "CABO French - Age catalog checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
