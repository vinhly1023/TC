...
=begin
English Web Content: Open Quick View overlay and check product information
=end

describe "Check information on Quick View page - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
