...
=begin
English Web Content: Verify user can search and check out app by using both Credit Card and Account Balance
=end
...
if env != 'PREVIEW' && env != 'PROD'
  ...
  describe "Search SKU - Purchase App with both credit card and account balance checking - Env: #{env} - Locale: #{General::LOCALE_CONST.upcase}" do
