...
=begin
English Web Content: Verify that Apps that don't support for current locale are not displayed
=end

describe "Search negative checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
