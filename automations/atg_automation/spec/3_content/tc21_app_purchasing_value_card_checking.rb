...
=begin
English Web Content: Verify user can search and check out app by using Redeem value code
=end
...
if env != 'PREVIEW' && env != 'PROD'
  ...
  describe "Search SKU and Purchase App using value card pin checking - Env: #{env} - Locale: #{General::LOCALE_CONST}" do
