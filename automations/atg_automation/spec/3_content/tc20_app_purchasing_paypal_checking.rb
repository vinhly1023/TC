...
=begin
English Web Content: Verify user can search and check out app by using PayPal
=end
...
if env != 'PREVIEW' && env != 'PROD'
  ...
  describe "Search SKU and Purchase App using paypal checking - Env: #{env} - Locale: #{General::LOCALE_CONST}" do
