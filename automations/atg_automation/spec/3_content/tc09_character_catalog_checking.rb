...
=begin
English Web Content: Verify that Products that match with Character and Locale should display
=end

describe "Character catalog checking - Env: #{General::ENV_CONST} - Locale: #{General::LOCALE_CONST.upcase}" do
